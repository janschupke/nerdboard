...
export class CryptocurrencyDataMapper extends BaseDataMapper<CryptocurrencyApiData[], CryptocurrencyTileData> {
  ...
  validate(apiResponse: unknown): apiResponse is CryptocurrencyApiData[] {
    return Array.isArray(apiResponse) && apiResponse.every((coin) =>
